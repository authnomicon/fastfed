...
Resolver.prototype.resolveAppProvider = function(url, options, cb) {
  if (typeof options == 'function') {
    cb = options;
    options = undefined;
  }
...
var METADATA = {
  ...
  application_provider: {
    key: 'appProvider',
    map: function(v) {
      return mapObj(v, mapper(APPLICATION_PROVIDER))
    }
  }
}
...
var APPLICATION_PROVIDER = {
  entity_id: 'id',
  fastfed_handshake_register_uri: 'handshakeRegisterURL'
}
